      ...
      <div className="footer-inner">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="footer-card footer-card-primary">
              <h4 className="footer-card-title">Ready to make an impact? Get started today</h4>
              <Link href="#" className="footer-button primary">
                Join as a Buyer
              </Link>
            </div>

            <div className="footer-card footer-card-secondary">
              <h4 className="footer-card-title">Become a Partner</h4>
              <Link href="#" className="footer-button secondary">
                Join as a Supplier
              </Link>
            </div>
          </div>
            ...
            <div className="footer-links-grid">
              {footerLinks.map((section) => (
                <div key={section.title}>
                  <h4 className="footer-card-title">{section.title}</h4>
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-copy">
            <p>© 2024 Pep-assign. All rights reserved.</p>
